...
#define DEVICE_QUALIFIER_DESCR_SZ   ( 5 )       /* device qualifier */
#define STRING_LAN_ID_SZ            ( 4 )       /* string language Id */
#define STRING_DESCR_SZ             ( 7 )       /* string descriptor */
...
#define CONFIG_DESCR_INC_SZ_PB2SR   ( 3 )       /* incremental size for two playback sample rates */
#endif /* ENABLE_PLAYBACK_TWO_SAMPLE_RATES */

#ifndef ENABLE_STEREO_RECORD
#define CONFIG_DESCR_INC_SZ_SR      ( 0 )
