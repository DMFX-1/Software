 ...
 *
 * \subsection MMC5x    TEST DESCRIPTION:
 ...
 *
 * \subsection MMC5y    TEST PROCEDURE:
 *  @li Insert "MMC/SD" card into the MMC/SD socket(J9) on the C5535/C5515 EVM
