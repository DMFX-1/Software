...
/** @file csl_emif_nand_dma_example.c
 *
 *  @brief Test code to verify the DMA mode functionality of CSL EMIF module.
 *
 *
 * \page    page13  CSL EMIF NAND EXAMPLE DOCUMENTATION
 *
 * \section EMIF2   EMIF NAND EXAMPLE2 - DMA MODE TEST
 *
 ...
 *
 * \subsection EMIF2y    TEST PROCEDURE:
