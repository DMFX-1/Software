...
typedef struct  {
    ...
    volatile Uint16 BMR;	//For Phoenix - Boot Mode Register-0x1C34 and RSVD7[2] is changed to RSVD7
    ...
    volatile Uint16 RSVD8[5]; //RSVD8
    #endif

#if 0
    volatile Uint16 CLKSTOP;
    volatile Uint16 RSVD8[1];

    volatile Uint16 MCSPICLKDIV;
...
// Below MCBSP part is added by Chandra. Needs Review
