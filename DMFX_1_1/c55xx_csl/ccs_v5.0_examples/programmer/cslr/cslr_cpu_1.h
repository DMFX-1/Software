...
*
*********************************************************************/
#ifndef _CSLR_CPU_1_H_
#define _CSLR_CPU_1_H_
...
#define CSL_CPU_IER0_HPI_MASK            (0x1000u)
#define CSL_CPU_IER0_HPI_SHIFT           (0x000Cu)
#define CSL_CPU_IER0_HPI_RESETVAL        (0x0000u)
/*----HPI Tokens----*/
#define CSL_CPU_IER0_HPI_DISABLE         (0x0000u)
#define CSL_CPU_IER0_HPI_ENABLE          (0x0001u)
...
#define CSL_CPU_IFR0_HPI_MASK            (0x1000u)
#define CSL_CPU_IFR0_HPI_SHIFT           (0x000Cu)
#define CSL_CPU_IFR0_HPI_RESETVAL        (0x0000u)
/*----HPI Tokens----*/
#define CSL_CPU_IFR0_HPI_DISABLED        (0x0000u)
#define CSL_CPU_IFR0_HPI_ENABLED         (0x0001u)
