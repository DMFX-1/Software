...
*
*********************************************************************/
#ifndef _CSLR_MCBSP_1_H_
#define _CSLR_MCBSP_1_H_
...
typedef struct  {
    ...
    volatile Uint16 REVTCRL;
    volatile Uint16 REVTCRU;
    volatile Uint16 RSVD16[2];
    volatile Uint16 XEVTCRL;
    volatile Uint16 RSVD17[3];
    volatile Uint16 RFLRL;
    volatile Uint16 RFLRU;
    volatile Uint16 RSVD18[2];
    volatile Uint16 XFLRL;
    volatile Uint16 XFLRU;
    volatile Uint16 RSVD19[2];
    volatile Uint16 RSYNCCNTL;
    volatile Uint16 RSYNCCNTU;
    volatile Uint16 RSVD20[2];
    volatile Uint16 XSYNCCNTL;
    volatile Uint16 XSYNCCNTU;
...
#define CSL_MCBSP_SPCRL_RSYNCERR_SYNCERR (0x0001u)
...
#define CSL_MCBSP_SPCRU_XSYNCERR_SYNCERR (0x0001u)
...
#define CSL_MCBSP_SRGRU_CLKSM_RESETVAL   (0x0000u)
/*----CLKSM Tokens----*/
...
#define CSL_MCBSP_SRGRU_RESETVAL         (0x0000u)
...
#define CSL_MCBSP_PCRU_RESETVAL          (0x0000u)
...
#define CSL_MCBSP_REVTCRL_REVTCI_MASK    (0x01FFu)
#define CSL_MCBSP_REVTCRL_REVTCI_SHIFT   (0x0000u)
#define CSL_MCBSP_REVTCRL_REVTCI_RESETVAL (0x0000u)

#define CSL_MCBSP_REVTCRL_RESETVAL       (0x0000u)

/* REVTCRU */


#define CSL_MCBSP_REVTCRU_RESETVAL       (0x0000u)

/* XEVTCRL */


#define CSL_MCBSP_XEVTCRL_XEVTCI_MASK    (0x01FFu)
#define CSL_MCBSP_XEVTCRL_XEVTCI_SHIFT   (0x0000u)
#define CSL_MCBSP_XEVTCRL_XEVTCI_RESETVAL (0x0000u)

#define CSL_MCBSP_XEVTCRL_RESETVAL       (0x0000u)

/* RFLRL */


#define CSL_MCBSP_RFLRL_RFRLEN3_MASK     (0x01FFu)
#define CSL_MCBSP_RFLRL_RFRLEN3_SHIFT    (0x0000u)
#define CSL_MCBSP_RFLRL_RFRLEN3_RESETVAL (0x0000u)

#define CSL_MCBSP_RFLRL_RESETVAL         (0x0000u)

/* RFLRU */


#define CSL_MCBSP_RFLRU_RESETVAL         (0x0000u)

/* XFLRL */


#define CSL_MCBSP_XFLRL_XFRLEN3_MASK     (0x01FFu)
#define CSL_MCBSP_XFLRL_XFRLEN3_SHIFT    (0x0000u)
#define CSL_MCBSP_XFLRL_XFRLEN3_RESETVAL (0x0000u)

#define CSL_MCBSP_XFLRL_RESETVAL         (0x0000u)

/* XFLRU */


#define CSL_MCBSP_XFLRU_RESETVAL         (0x0000u)

/* RSYNCCNTL */

#define CSL_MCBSP_RSYNCCNTL_RSYNCCNT_MASK (0xFFFFu)
#define CSL_MCBSP_RSYNCCNTL_RSYNCCNT_SHIFT (0x0000u)
#define CSL_MCBSP_RSYNCCNTL_RSYNCCNT_RESETVAL (0x0000u)

#define CSL_MCBSP_RSYNCCNTL_RESETVAL     (0x0000u)

/* RSYNCCNTU */


#define CSL_MCBSP_RSYNCCNTU_RESETVAL     (0x0000u)

/* XSYNCCNTL */

#define CSL_MCBSP_XSYNCCNTL_XSYNCCNT_MASK (0xFFFFu)
#define CSL_MCBSP_XSYNCCNTL_XSYNCCNT_SHIFT (0x0000u)
#define CSL_MCBSP_XSYNCCNTL_XSYNCCNT_RESETVAL (0x0000u)

#define CSL_MCBSP_XSYNCCNTL_RESETVAL     (0x0000u)

/* XSYNCCNTU */


#define CSL_MCBSP_XSYNCCNTU_RESETVAL     (0x0000u)

/* PIDL */

#define CSL_MCBSP_PIDL_CLASS_MASK        (0xFF00u)
#define CSL_MCBSP_PIDL_CLASS_SHIFT       (0x0008u)
#define CSL_MCBSP_PIDL_CLASS_RESETVAL    (0x0001u)

#define CSL_MCBSP_PIDL_REVISION_MASK     (0x00FFu)
#define CSL_MCBSP_PIDL_REVISION_SHIFT    (0x0000u)
#define CSL_MCBSP_PIDL_REVISION_RESETVAL (0x0001u)

#define CSL_MCBSP_PIDL_RESETVAL          (0x0101u)

/* PIDU */


#define CSL_MCBSP_PIDU_TYPE_MASK         (0x00FFu)
#define CSL_MCBSP_PIDU_TYPE_SHIFT        (0x0000u)
#define CSL_MCBSP_PIDU_TYPE_RESETVAL     (0x0002u)

#define CSL_MCBSP_PIDU_RESETVAL          (0x0002u)
