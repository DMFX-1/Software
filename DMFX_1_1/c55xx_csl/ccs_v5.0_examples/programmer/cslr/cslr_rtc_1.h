...
#define CSL_RTC_RTCDAY_DAY0_RESETVAL     (0x0001u)

#define CSL_RTC_RTCDAY_RESETVAL          (0x0001u)
...
#define CSL_RTC_RTCMONTH_MONTH0_RESETVAL (0x0001u)

#define CSL_RTC_RTCMONTH_RESETVAL        (0x0001u)
...
#define CSL_RTC_RTCOSC_OSCRES_RESETVAL   (0x000Bu)

#define CSL_RTC_RTCOSC_RESETVAL          (0x000Bu)
...
#define CSL_RTC_RGKR_LSW_GKC_LSW_MASK    (0xFFFFu)
#define CSL_RTC_RGKR_LSW_GKC_LSW_SHIFT   (0x0000u)
#define CSL_RTC_RGKR_LSW_GKC_LSW_RESETVAL (0x0000u)

#define CSL_RTC_RGKR_LSW_RESETVAL        (0x0000u)

/* RGKR_MSW */

#define CSL_RTC_RGKR_MSW_GKC_MSW_MASK    (0xFFFFu)
#define CSL_RTC_RGKR_MSW_GKC_MSW_SHIFT   (0x0000u)
#define CSL_RTC_RGKR_MSW_GKC_MSW_RESETVAL (0x0000u)

#define CSL_RTC_RGKR_MSW_RESETVAL        (0x0000u)
