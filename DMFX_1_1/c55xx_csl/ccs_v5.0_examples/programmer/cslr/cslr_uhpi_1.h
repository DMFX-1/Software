...
* file: cslr_uhpi_1.h
*
* Brief: This file contains the Register Description for uhpi
*
*********************************************************************/
...
typedef struct  {
    ...
    volatile Uint16 HPICL;
    volatile Uint16 RSVD10[3];
    volatile Uint16 HPIAWL;
    volatile Uint16 HPIAWU;
    volatile Uint16 RSVD11[2];
    volatile Uint16 HPIARL;
    volatile Uint16 HPIARU;
    volatile Uint16 RSVD12[2];
    volatile Uint16 XHPIAWL;
    volatile Uint16 XHPIAWU;
    volatile Uint16 RSVD13[2];
    volatile Uint16 XHPIARL;
    volatile Uint16 XHPIARU;
} CSL_UhpiRegs;
...
#define CSL_UHPI_HPICL_NRDY_HPID_WR_MASK (0x8000u)
#define CSL_UHPI_HPICL_NRDY_HPID_WR_SHIFT (0x000Fu)
#define CSL_UHPI_HPICL_NRDY_HPID_WR_RESETVAL (0x0000u)
/*----NRDY_HPID_WR Tokens----*/
#define CSL_UHPI_HPICL_NRDY_HPID_WR_READY (0x0000u)
#define CSL_UHPI_HPICL_NRDY_HPID_WR_NRDY (0x0001u)

#define CSL_UHPI_HPICL_NRDY_HPIDP_WR_MASK (0x4000u)
#define CSL_UHPI_HPICL_NRDY_HPIDP_WR_SHIFT (0x000Eu)
#define CSL_UHPI_HPICL_NRDY_HPIDP_WR_RESETVAL (0x0000u)
/*----NRDY_HPIDP_WR Tokens----*/
#define CSL_UHPI_HPICL_NRDY_HPIDP_WR_READY (0x0000u)
#define CSL_UHPI_HPICL_NRDY_HPIDP_WR_NRDY (0x0001u)

#define CSL_UHPI_HPICL_NRDY_HPID_RD_MASK (0x2000u)
#define CSL_UHPI_HPICL_NRDY_HPID_RD_SHIFT (0x000Du)
#define CSL_UHPI_HPICL_NRDY_HPID_RD_RESETVAL (0x0000u)
/*----NRDY_HPID_RD Tokens----*/
#define CSL_UHPI_HPICL_NRDY_HPID_RD_READY (0x0000u)
#define CSL_UHPI_HPICL_NRDY_HPID_RD_NRDY (0x0001u)

#define CSL_UHPI_HPICL_NRDY_HPIA_WR_MASK (0x1000u)
#define CSL_UHPI_HPICL_NRDY_HPIA_WR_SHIFT (0x000Cu)
#define CSL_UHPI_HPICL_NRDY_HPIA_WR_RESETVAL (0x0000u)
/*----NRDY_HPIA_WR Tokens----*/
#define CSL_UHPI_HPICL_NRDY_HPIA_WR_READY (0x0000u)
#define CSL_UHPI_HPICL_NRDY_HPIA_WR_NRDY (0x0001u)

#define CSL_UHPI_HPICL_HPIA_RW_SEL_MASK  (0x0800u)
#define CSL_UHPI_HPICL_HPIA_RW_SEL_SHIFT (0x000Bu)
#define CSL_UHPI_HPICL_HPIA_RW_SEL_RESETVAL (0x0000u)
/*----HPIA_RW_SEL Tokens----*/
#define CSL_UHPI_HPICL_HPIA_RW_SEL_WRITE (0x0000u)
#define CSL_UHPI_HPICL_HPIA_RW_SEL_READ  (0x0001u)

#define CSL_UHPI_HPICL_LB_MODE_MASK      (0x0400u)
#define CSL_UHPI_HPICL_LB_MODE_SHIFT     (0x000Au)
#define CSL_UHPI_HPICL_LB_MODE_RESETVAL  (0x0000u)
/*----LB_MODE Tokens----*/
#define CSL_UHPI_HPICL_LB_MODE_DISABLE   (0x0000u)
#define CSL_UHPI_HPICL_LB_MODE_ENABLE    (0x0001u)

#define CSL_UHPI_HPICL_DUAL_HPIA_MASK    (0x0200u)
#define CSL_UHPI_HPICL_DUAL_HPIA_SHIFT   (0x0009u)
#define CSL_UHPI_HPICL_DUAL_HPIA_RESETVAL (0x0000u)
/*----DUAL_HPIA Tokens----*/
#define CSL_UHPI_HPICL_DUAL_HPIA_DISABLE (0x0000u)
#define CSL_UHPI_HPICL_DUAL_HPIA_ENABLE  (0x0001u)

#define CSL_UHPI_HPICL_HWOB_STAT_MASK    (0x0100u)
#define CSL_UHPI_HPICL_HWOB_STAT_SHIFT   (0x0008u)
#define CSL_UHPI_HPICL_HWOB_STAT_RESETVAL (0x0000u)
/*----HWOB_STAT Tokens----*/
#define CSL_UHPI_HPICL_HWOB_STAT_ZERO    (0x0000u)
#define CSL_UHPI_HPICL_HWOB_STAT_ONE     (0x0001u)

#define CSL_UHPI_HPICL_HPI_RST_MASK      (0x0080u)
#define CSL_UHPI_HPICL_HPI_RST_SHIFT     (0x0007u)
#define CSL_UHPI_HPICL_HPI_RST_RESETVAL  (0x0000u)
/*----HPI_RST Tokens----*/
#define CSL_UHPI_HPICL_HPI_RST_CLEAR     (0x0000u)
#define CSL_UHPI_HPICL_HPI_RST_GENERATE  (0x0001u)

#define CSL_UHPI_HPICL_RESET_MASK        (0x0040u)
#define CSL_UHPI_HPICL_RESET_SHIFT       (0x0006u)
#define CSL_UHPI_HPICL_RESET_RESETVAL    (0x0000u)
/*----RESET Tokens----*/
#define CSL_UHPI_HPICL_RESET_DISABLE     (0x0000u)
#define CSL_UHPI_HPICL_RESET_ENABLE      (0x0001u)

#define CSL_UHPI_HPICL_XHPIA_MASK        (0x0020u)
#define CSL_UHPI_HPICL_XHPIA_SHIFT       (0x0005u)
#define CSL_UHPI_HPICL_XHPIA_RESETVAL    (0x0000u)
/*----XHPIA Tokens----*/
#define CSL_UHPI_HPICL_XHPIA_DISABLE     (0x0000u)
#define CSL_UHPI_HPICL_XHPIA_ENABLE      (0x0001u)

#define CSL_UHPI_HPICL_FETCH_MASK        (0x0010u)
#define CSL_UHPI_HPICL_FETCH_SHIFT       (0x0004u)
#define CSL_UHPI_HPICL_FETCH_RESETVAL    (0x0000u)
/*----FETCH Tokens----*/
#define CSL_UHPI_HPICL_FETCH_ZERO        (0x0000u)
#define CSL_UHPI_HPICL_FETCH_ONE         (0x0001u)

#define CSL_UHPI_HPICL_HRDY_MASK         (0x0008u)
#define CSL_UHPI_HPICL_HRDY_SHIFT        (0x0003u)
#define CSL_UHPI_HPICL_HRDY_RESETVAL     (0x0000u)
/*----HRDY Tokens----*/
#define CSL_UHPI_HPICL_HRDY_BUSY         (0x0000u)
#define CSL_UHPI_HPICL_HRDY_READY        (0x0001u)

#define CSL_UHPI_HPICL_HINT_MASK         (0x0004u)
#define CSL_UHPI_HPICL_HINT_SHIFT        (0x0002u)
#define CSL_UHPI_HPICL_HINT_RESETVAL     (0x0000u)
/*----HINT Tokens----*/
#define CSL_UHPI_HPICL_HINT_CLEAR        (0x0000u)
#define CSL_UHPI_HPICL_HINT_GENERATE     (0x0001u)

#define CSL_UHPI_HPICL_DSP_INT_MASK      (0x0002u)
#define CSL_UHPI_HPICL_DSP_INT_SHIFT     (0x0001u)
#define CSL_UHPI_HPICL_DSP_INT_RESETVAL  (0x0000u)
/*----DSP_INT Tokens----*/
#define CSL_UHPI_HPICL_DSP_INT_CLEAR     (0x0000u)
#define CSL_UHPI_HPICL_DSP_INT_GENERATE  (0x0001u)

#define CSL_UHPI_HPICL_HWOB_MASK         (0x0001u)
#define CSL_UHPI_HPICL_HWOB_SHIFT        (0x0000u)
#define CSL_UHPI_HPICL_HWOB_RESETVAL     (0x0000u)
/*----HWOB Tokens----*/
#define CSL_UHPI_HPICL_HWOB_MSB          (0x0000u)
#define CSL_UHPI_HPICL_HWOB_LSB          (0x0001u)

#define CSL_UHPI_HPICL_RESETVAL          (0x0000u)

/* HPIAWL */

#define CSL_UHPI_HPIAWL_HPIAW_MASK       (0xFFFFu)
#define CSL_UHPI_HPIAWL_HPIAW_SHIFT      (0x0000u)
#define CSL_UHPI_HPIAWL_HPIAW_RESETVAL   (0x0000u)

#define CSL_UHPI_HPIAWL_RESETVAL         (0x0000u)

/* HPIAWU */

#define CSL_UHPI_HPIAWU_HPIAW_MASK       (0xFFFFu)
#define CSL_UHPI_HPIAWU_HPIAW_SHIFT      (0x0000u)
#define CSL_UHPI_HPIAWU_HPIAW_RESETVAL   (0x0000u)

#define CSL_UHPI_HPIAWU_RESETVAL         (0x0000u)

/* HPIARL */

#define CSL_UHPI_HPIARL_HPIAR_MASK       (0xFFFFu)
#define CSL_UHPI_HPIARL_HPIAR_SHIFT      (0x0000u)
#define CSL_UHPI_HPIARL_HPIAR_RESETVAL   (0x0000u)

#define CSL_UHPI_HPIARL_RESETVAL         (0x0000u)

/* HPIARU */

#define CSL_UHPI_HPIARU_HPIAR_MASK       (0xFFFFu)
#define CSL_UHPI_HPIARU_HPIAR_SHIFT      (0x0000u)
#define CSL_UHPI_HPIARU_HPIAR_RESETVAL   (0x0000u)

#define CSL_UHPI_HPIARU_RESETVAL         (0x0000u)

/* XHPIAWL */

#define CSL_UHPI_XHPIAWL_XHPIAW_MASK     (0xFFFFu)
#define CSL_UHPI_XHPIAWL_XHPIAW_SHIFT    (0x0000u)
#define CSL_UHPI_XHPIAWL_XHPIAW_RESETVAL (0x0000u)

#define CSL_UHPI_XHPIAWL_RESETVAL        (0x0000u)

/* XHPIAWU */

#define CSL_UHPI_XHPIAWU_XHPIAW_MASK     (0xFFFFu)
#define CSL_UHPI_XHPIAWU_XHPIAW_SHIFT    (0x0000u)
#define CSL_UHPI_XHPIAWU_XHPIAW_RESETVAL (0x0000u)

#define CSL_UHPI_XHPIAWU_RESETVAL        (0x0000u)

/* XHPIARL */

#define CSL_UHPI_XHPIARL_XHPIAR_MASK     (0xFFFFu)
#define CSL_UHPI_XHPIARL_XHPIAR_SHIFT    (0x0000u)
#define CSL_UHPI_XHPIARL_XHPIAR_RESETVAL (0x0000u)

#define CSL_UHPI_XHPIARL_RESETVAL        (0x0000u)

/* XHPIARU */

#define CSL_UHPI_XHPIARU_XHPIAR_MASK     (0xFFFFu)
#define CSL_UHPI_XHPIARU_XHPIAR_SHIFT    (0x0000u)
#define CSL_UHPI_XHPIARU_XHPIAR_RESETVAL (0x0000u)

#define CSL_UHPI_XHPIARU_RESETVAL        (0x0000u)
