  LCDC example to verify 262k color mode operation
 
  LCD 262K COLOR MODE TEST
  ...
  TEST PROCEDURE:
   ...
   2. Open the project "CSL_LCDC_262kColorModeExample_Out.pjt" and build it
  ...
  TEST RESULT:
    ...
    Upper Half of the LCD panel should be filled with WHITE color
    Lower Half of the LCD panel should be filled with BLUE color