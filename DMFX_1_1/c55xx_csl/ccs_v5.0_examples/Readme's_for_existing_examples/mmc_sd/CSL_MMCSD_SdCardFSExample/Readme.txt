  ...
  TEST PROCEDURE:
   ...
   3. Open the project "CSL_MMCSD_SdCardFSExample_Out.pjt" and build it
  ...
  TEST RESULT:
    ...
    File created should be accessible from a windows PC using card reader.