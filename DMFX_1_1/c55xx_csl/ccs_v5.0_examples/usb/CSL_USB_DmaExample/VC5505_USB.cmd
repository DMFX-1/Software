...
MEMORY
{
  PAGE 0:
	...
	SARAM3(RW)    : origin = 0020000h length = 002000h  
	SARAM4(RW)    : origin = 0022000h length = 002000h  
	SARAM5(RW)    : origin = 0024000h length = 002000h  
    PROG(RX)      : origin = 0026000h length = 00A000h        
}
...
SECTIONS
{
  ...
  .buffer4   : > SARAM3 , fill =0 
  .buffer5   : > SARAM4 , fill =0 
  .buffer6   : > SARAM5 , fill =0 
}
