/*  ============================================================================
 *   Copyright (c) Texas Instruments Inc 2002, 2003, 2004, 2005, 2008, 2012
 *
 ...
 *
 * 	\page    page23  CSL SDIO DRIVER DOCUMENTATION
 * 
 * TEST DESCRIPTION:
 * =================
 *		This test verifies SDIO driver of the C5505/C5515/C5517 DSP. Spectec SDIO
 ...
 *  TEST PROCEDURE:
 *  ===============
 *  Open the CCS and connect the target (C5505/C5515/C5517 EVM)
 *  Insert the SDIO GPS device into MMC/SD slot of C5515/C5505/C5517 EVM properly
