...
_TSK_idle = TSK_idle;
_mainTsk = mainTsk;
_AudioTx_Tsk = AudioTx_Tsk;
_AudioRx_Tsk = AudioRx_Tsk;
_Tsk_I2c_Intc_SlaveRx = Tsk_I2c_Intc_SlaveRx;
_IDL_cpuLoad = IDL_cpuLoad;
_LNK_dataPump = LNK_dataPump;
_RTA_dispatcher = RTA_dispatcher;
_LOG_system = LOG_system;
_trace = trace;
_SEM_DmaRxLeftComplete = SEM_DmaRxLeftComplete;
_SEM_I2cDevBusy = SEM_I2cDevBusy;
_SEM_TxSampsSent = SEM_TxSampsSent;
_SEM_DmaRxRightComplete = SEM_DmaRxRightComplete;
_SEM_I2c_Intc = SEM_I2c_Intc;
_SEM_Int0 = SEM_Int0;
_IDL_busyObj = IDL_busyObj;
_STS_I2c_Intc_SlaveRx = STS_I2c_Intc_SlaveRx;
_STS_AudioRx_Tsk = STS_AudioRx_Tsk;
_STS_AudioTx_Tsk = STS_AudioTx_Tsk;
...
SECTIONS {
       ...
       /* no HWI stubs are necessary */
        ...
        .AudioTx_Tsk$stk: block(0x20000){
            *(.AudioTx_Tsk$stk)
        } > DARAM PAGE 0

        .AudioRx_Tsk$stk: block(0x20000){
            *(.AudioRx_Tsk$stk)
        } > DARAM PAGE 0

        .Tsk_I2c_Intc_SlaveRx$stk: block(0x20000){
            *(.Tsk_I2c_Intc_SlaveRx$stk)
        } > DARAM PAGE 0

        /* LOG_system buffer */
        .LOG_system$buf: block(0x20000) align = 0x1000 {} > DARAM PAGE 0
