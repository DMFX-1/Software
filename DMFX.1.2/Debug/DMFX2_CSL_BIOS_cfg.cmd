...
_TSK_idle = TSK_idle;
_MainTsk = MainTsk;
_Tsk_LcdMenu = Tsk_LcdMenu;
_Tsk_I2c_Intc_MasterTx = Tsk_I2c_Intc_MasterTx;
...
_STS_LcdMenu = STS_LcdMenu;
_STS_I2c_Intc_MasterTx = STS_I2c_Intc_MasterTx;
...
SECTIONS {
       ...
       /* no HWI stubs are necessary */
        ...
        .Tsk_LcdMenu$stk: block(0x20000){
            *(.Tsk_LcdMenu$stk)
        } > DARAM PAGE 0

        .Tsk_I2c_Intc_MasterTx$stk: block(0x20000){
            *(.Tsk_I2c_Intc_MasterTx$stk)
        } > DARAM PAGE 0
